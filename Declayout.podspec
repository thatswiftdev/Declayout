#
#  Be sure to run `pod spec lint Declayout.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Bayu Kurniawan"
  # spec.authors            = { "Bayu Kurniawan" => "kurniawan.bayu@hotmail.com" }
